...
Please ensure these components are properly imported to your package's entry point.`);
    ...
    analyzeComponent(node) {
        ...
        if (argsSymbol.members) {
            inputs = this.analyzeSymbols({ component: componentName, inputOutput: InputOutput.Neither, typeName: argsSymbol.getName() }, symbolTableToSymbols(argsSymbol.members), argsParam);
        }
        let outputs = {};
