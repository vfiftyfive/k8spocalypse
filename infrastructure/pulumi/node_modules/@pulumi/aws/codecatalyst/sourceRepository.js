...
class SourceRepository extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new SourceRepository(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
SourceRepository.__pulumiType = 'aws:codecatalyst/sourceRepository:SourceRepository';
