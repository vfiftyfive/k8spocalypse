...
exports.IngestionDestination = exports.Ingestion = exports.AppBundle = exports.AppAuthorizationConnection = exports.AppAuthorization = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.AppAuthorization = null;
utilities.lazyLoad(exports, ["AppAuthorization"], () => require("./appAuthorization"));
exports.AppAuthorizationConnection = null;
...
exports.IngestionDestination = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws:appfabric/appAuthorizationConnection:AppAuthorizationConnection":
                return new exports.AppAuthorizationConnection(name, undefined, { urn });
            ...
            case "aws:appfabric/ingestionDestination:IngestionDestination":
                return new exports.IngestionDestination(name, undefined, { urn });
            default:
