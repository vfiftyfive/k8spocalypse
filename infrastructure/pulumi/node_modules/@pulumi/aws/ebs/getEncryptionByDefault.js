...
function getEncryptionByDefault(opts) {
    ...
    return pulumi.runtime.invoke("aws:ebs/getEncryptionByDefault:getEncryptionByDefault", {}, opts);
}
 ...
 * ```
 */
function getEncryptionByDefaultOutput(opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("aws:ebs/getEncryptionByDefault:getEncryptionByDefault", {}, opts);
}
