...
exports.getSolutionStackOutput = exports.getSolutionStack = exports.getHostedZoneOutput = exports.getHostedZone = exports.getApplicationOutput = exports.getApplication = exports.Environment = exports.ConfigurationTemplate = exports.ApplicationVersion = exports.Application = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.Application = null;
utilities.lazyLoad(exports, ["Application"], () => require("./application"));
exports.ApplicationVersion = null;
utilities.lazyLoad(exports, ["ApplicationVersion"], () => require("./applicationVersion"));
exports.ConfigurationTemplate = null;
...
exports.getSolutionStack = null;
exports.getSolutionStackOutput = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws:elasticbeanstalk/applicationVersion:ApplicationVersion":
                return new exports.ApplicationVersion(name, undefined, { urn });
            case "aws:elasticbeanstalk/configurationTemplate:ConfigurationTemplate":
                return new exports.ConfigurationTemplate(name, undefined, { urn });
