...
const nodegroup_2 = require("./nodegroup");
...
describe("isGravitonInstance", () => {
    ...
    describe("getArchitecture", () => {
        ...
        test("should throw an error when both x86_64 and arm64 instances are provided", () => {
            ...
            expect(() => {
                (0, nodegroup_2.getArchitecture)(instanceTypes);
            }).toThrowError("Cannot determine architecture of instance types. The provided instance types do not share a common architecture");
        });
...
//# sourceMappingURL=nodegroup.test.js.map